...
in machine translation from natural language to logic using 
SUMO \url{https://github.com/ontologyportal/sumo} terms.  User wishing to install the system should follow the README at \url{https://github.com/ontologyportal/sumonlp}
\end{sloppypar}

The system uses machine learning techniques to simplify inputs and convert them to mathematical logic expressions that can then be used in formal theorem proving with Vampire or other provers.
...
\section{Synthetic Corpus Generation}
